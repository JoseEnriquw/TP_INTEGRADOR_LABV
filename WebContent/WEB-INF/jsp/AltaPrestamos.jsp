        ...
        <div class="divFormulario">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select class="form-control">
                                ...
                                <option>Cuentos inconclusos de numenor y la tierra media </option>
                            </select>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label><b>Cantidad de dias: </b></label>
                            <input type="number" min="1"  class="form-control" />
                        </div>
                        <div class="col-6">
                            <label><b>Cliente:</b></label>
                            <input type="text" placeholder="Ingrese el DNI" class="form-control" />
                        </div>
                    </div>                  
