...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-0evHe/X+R7YkIZDRvuzKMRqM+OrBnVFBL6DOitfPri4tjfHxaWutUpFmBp4vmVor" crossorigin="anonymous">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script> 
     ...
     <script src="${pageContext.request.contextPath}/resources/js/crearModal.js"></script>
 ...
 <nav class="navbar navbar-dark bg-dark">
        ...
        <input type="hidden" class="nav-link" name="usuarioLogueado" value="${Usuario}"/>
            <a class="navbar-brand" id="usuarioLogueado" >${Usuario}</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="Redirect.html?usuarioLogueado=${Usuario}&page=Clientes"> Clientes</a>
                    <a class="nav-link" href="Redirect.html?usuarioLogueado=${Usuario}&page=Todosloslibros"> Todos los Libros</a>
                    <a class="nav-link" href="Redirect.html?usuarioLogueado=${Usuario}&page=Biblioteca"> Biblioteca</a>
                    <a class="nav-link" href="Redirect.html?usuarioLogueado=${Usuario}&page=Prestamos"> Prestamos</a>
                    <a class="nav-link" href="Redirect.html?usuarioLogueado=${Usuario}&page=Autores"> Autores</a>
                    <a class="nav-link" href="Redirect.html?usuarioLogueado=${Usuario}&page=Usuarios"> Usuarios</a>
