...
public class Util {
	...
	public static String Q_BIBLIOTECA_BY_IDLIBRO = "FROM EBiblioteca WHERE isbn =? AND estado = 'En biblioteca'";
	public static String Q_BIBLIOTECA_BY_ESTADO = "FROM EBiblioteca WHERE estado = ?";
